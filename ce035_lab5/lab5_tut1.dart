import 'package:lab_5_tut_1.dart' as lab_5_tutorial_1;
...
void main(List<String> arguments) {
  // print('Hello world: ${lab5_tut1.calculate()}!');
  // Colections:
  // Main 3 types:
  /*
  ...
  */
  ...
  const desserts = [
    ...
    'JD',
    'Smit'
  ]; //This is same as , final desserts = const['tejas','JD','Smit'];
  // Below 3 will not work because list is const
  // desserts.add('Mirat');
  // desserts.remove('tejas');
  // desserts[0] = 'abc';
  ...
  */
  ...
  // Challenge 3:
  User user1 = User(1, 'tejas');
  User user2 = User(2, 'JD');
  User user3 = User(3, 'Mirat');

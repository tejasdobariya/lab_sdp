import 'package:lab4_tut1.dart' as lab4_tutorial1;
import 'user.dart';
import 'dart:math';
...
class Student {
  Student({firstName = 'tejas', lastname = 'dobariya', grade = 0})
      : this.firstName = 'tejas',
        this.lastName = 'dobariya',
        this.grade = 100;
...
void main(List<String> arguments) {
  ...
  */
  final email = Email();
  email.value = 'tejasdobariya@gmail.com';

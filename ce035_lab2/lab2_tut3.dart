void main() {
  ...
  */
  /*
        ...
        const name = 'tejas ';
        message += name; // 'Hello my name is tejas '
 
        final message = StringBuffer();
        message.write('Hello');
        message.write(' my name is ');
        message.write('tejas');
        message.toString(); // "Hello my name is tejas "
  ...
  */
  /*
        ...
        const name = "tejas ";
        const intro = "Hello , My name is $name"; //Hello my name is tejas 
